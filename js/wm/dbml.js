...
class WLet extends WLetBase {
    ...
    prep_props () {
        ...
        //0
        this.waer_trl =         "э ω I я з а å м ξ г к т в у щ б о ρ ш л c ё р ж й п х е и w д θ н э ы å ф ˉ ˉ ⁝ ⁅ ⁆ ⁝ͱ ⁝|⁝ ео ".split(" "); this.waer_trl.push(" ")

        //1
        this.waer_xog =         "⅄ ͱ ɾ q ʌ p չ ↷ m ϙ I C ʙ ʜ O Ƒ ɯ ϵ ʞ d ψ Ξ ʀ Պ b Ʋ ⊥ է T Ɣ Δ փ n Y Ӻ = ϟ ˉ ˉ ⁝ ⁅ ⁆ ⁝ͱ ⁝|⁝ Ϣ ".split(" "); this.waer_xog.push(" ") //ꙈꙉƕʎըϯʞѦŦ

        //2
        this.waer_cyr =         "э ы ь я з а ъ м ю г к т в у щ б о Р ш л с ё р ж й п х е и В д ц н Э Ы Ъ ф – - _ ( ) ? ! ео ".split(" "); this.waer_cyr.push(" ")

        //2.0 https://en.wikipedia.org/wiki/International_Phonetic_Alphabet
        this.waer_IPA =         "ɛ ω ʔ æ z ʌ ɔ m ʀ̥ g k t v u ç b ɔ̝ ɹ ʃ ʟ s ø̞ ɾ ʒ ʝ p x e i β d̪ θ n @ @ @ f – - _ ( ) ? ! @ ".split(" "); this.waer_IPA.push(" ") //ŋ y h q ɣ ð 

        //2.1
        this.waer_cyr_tech =    "э ввъ 1 я з а ъ м рр г к т в у щ б о р1 ш л с ё р ж й п х е и в1 д ц н Э Вв1 Ъ ф – - _ ( ) ? ! ео ".split(" "); this.waer_cyr.push(" ")
        this.waer_cyr_not_ttf = "э ы 1 я з а ъ м ч г к т в у щ б о ь ш л с ё р ж й п х е и 8 д ц н Э Ы Ъ ф – - _ ( ) ? ! ео ".split(" "); this.waer_cyr.push(" ")

        //3
        this.waer_lat =         "e y I q z a A m X g k t b u C b o R S l s E r J j p h e i w d T n E Y $ f – - _ ( ) ? ! eo ".split(" "); this.waer_lat.push(" ")
    ...
    xog_cyr2hog (str, SorT=0) {
        ...
        if (SorT==1)
            ...
            ho = this.waer_cyr_tech
        else if (SorT==3)
            ho = this.waer_cyr_not_ttf
        else if (SorT==4)
            ho = this.waer_IPA
