...
var WLLEN = 5 // var ChangeSpiralRadiusParam = 0
var GUI = {
    wl:WLLEN, // csrp: ChangeSpiralRadiusParam
...
// gui = new dat.GUI(), wlctl = gui.add(GUI, "wl", 2, 33, 1); wlctl.onChange((value)=>{WLLEN = value}); gui.width = 100;
// var csrpctl = gui.add(GUI, "csrp", -1, 1, 0.01); csrpctl.onChange((value)=>{ChangeSpiralRadiusParam = value})
...
function animate () {
    function Build () {
      ...
      /* ON SPIRALS - OBSOLETE
        ...
        // dbm.spiral (dbm.A, col='purple')
        // dbm.spiral (dbm.T, col='red')
        // dbm.spiral (dbm.ThLPh, col='violet')
      */
    }
